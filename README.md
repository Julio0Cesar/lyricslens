...
how many lines still to come are shown dimmed underneath, a karaoke mode that
fills the line as the song moves through it, and whether the overlay clears
